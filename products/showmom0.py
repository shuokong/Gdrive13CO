...
if mom0mask == 1:
    ...
    fits.writeto('13mom0mask.fits', hdu1.data, hdu1.header, clobber=True)
...
if mom0 == 1:
    ...
    ff.show_colorscale(cmap='afmhot', pmin=0.25, vmax=200, stretch='sqrt')
    ...
    ff.add_label(beamx+1.0,beamy+2.0,'0th-moment $^{13}$CO(1-0)',size=12,weight='bold')
