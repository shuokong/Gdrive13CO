...
hdulist1=pyfits.open('lombardi_colorT_on_13co_header.fits') #for Tex
hdulist2=pyfits.open('pixel6_convol18_mom0_13co_pix_2_Tmb.fits') #for mom0
hdulist3=pyfits.open('stutz_on_13co_header.fits') #for newNICEST38.fits or newNICER38.fits
...
regionfiles = [[[1,1115,812,1420],'north','north'],[[1,971,812,1115],'central','central'],[[1,539,812,971],'south','south'],[[1,1,812,539],'furthersouth','L1641']]
...
pdfname = 'multicolor_13co_NH_tdust.pdf'
