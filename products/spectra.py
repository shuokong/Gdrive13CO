...
regionfiles = [['north_mask_13co_pix_2_Tmb.fits','north','north'],['central_mask_13co_pix_2_Tmb.fits','central','central'],['south_mask_13co_pix_2_Tmb.fits','south','south'],['furthersouth_mask_13co_pix_2_Tmb.fits','furthersouth','L1641']]
...
for nn,ii in enumerate(regionfiles):
    ...
    plt.xlim(0,20.) 
    ax.set_ylim(-0.5,8)
    ax.vlines(velocity[peakind],-0.5,max(spectrum),linestyle='dashed')
