...
########################
corenums, xw, yw, corevelocities, coresnr = np.loadtxt('GAScores_13CO_peak_velocities.txt',usecols=(0,1,2,3,4),unpack=True)
########################
...
pdfname = 'velocity_distribution_13CO.pdf'
