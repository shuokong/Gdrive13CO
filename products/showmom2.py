...
hdu1 = fits.open('mom2_13co_pix_2_Tmb.fits')[0]
xcenter=84
ycenter=-6
wid = 1.5
hei = 2.4
...
ff.show_colorscale(cmap='Purples', vmin=0, vmax=4, stretch='linear')
...
ff.add_label(beamx+1.0,beamy+2.0,'2nd-moment $^{13}$CO(1-0)',size=12,weight='bold')
#ff.tick_labels.set_xformat('dd')
#ff.tick_labels.set_yformat('dd')
pdfname = 'mom2_13co_pix_2_Tmb.pdf'
