...
fitsfiles={'color':{'fname':'chan1_mask_imfit_13co_pix_2_Tmb.fits','title':'13CO(1-0)','bmaj':0,'bmin':0,'galpa':0},
        'template':{'fname':'chan1_mask_imfit_13co_pix_2_Tmb.fits'},
         'channel':{'fname':'mask_han1_mask_imfit_13co_pix_2_Tmb.fits','title':r'13CO(1-0)','mincolor':0,'maxcolor':70},
           }
