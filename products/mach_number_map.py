...
hdu2 = fits.open('lombardi_colorT_on_13co_header.fits')[0]
...
hdu4.writeto('soundspeed_map_from_tex12.fits', output_verify='exception', overwrite=True, checksum=False)

tdustdata = hdu2.data
print 'tdustdata.shape',tdustdata.shape
hdu2.data = np.sqrt(gamma*Rgas*tdustdata/m_mol)/1.e5 # in unit km/s
hdu2.writeto('soundspeed_map_from_lombardi_tdust.fits', output_verify='exception', overwrite=True, checksum=False)
