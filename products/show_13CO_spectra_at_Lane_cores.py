...
for counter,coresubgroup in enumerate(coregroups):
    ...
    pdfname = 'Lane_cores_spectra/averspec13number'+str(region)+'.pdf'
...
np.savetxt('Lane_cores_spectra/Getsources_cores_13CO_peak_velocities.txt',savetxtarr,fmt='%3d %20.5f %20.5f %10.2f %5.1f')
