...
# load hdu
hdu1 = fits.open('re_main_13co_pix_2_Tmb.fits')[0]
hdu2 = fits.open('re_l1641c_13co_pix_2_Tmb.fits')[0]
...
# write to file
fits.writeto('join_13co_pix_2_Tmb.fits', joindat, hdu1.header, clobber=True)
